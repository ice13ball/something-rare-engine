      ...
      paragraphs: [
        "The land view maps the terrestrial mining industry and its environmental context:",
        {
          list: [
            ...
            "Tree Cover Loss — annual deforestation at 30 m resolution (2001–2024) plus weekly GLAD/RADD alerts (University of Maryland / WRI).",
            "Active Fires — near-real-time fire detection from MODIS and VIIRS (NASA LANCE, updated within 3 hours).",
