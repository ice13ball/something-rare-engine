...
const LAYER_META = {
  ...
  'tailings':            { label: 'Tailings Dams',               source: 'GRID-Arendal / UNEP',                         category: 'land', desc: '1,800+ mine tailings dams, with the operator\'s own disclosed hazard rating where available — tracking one of mining\'s greatest environmental hazards.' },
